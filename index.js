...
const projectPageURL = process.env.URL || "https://gcp-eu1.gigalixirapp.com"; //
const intervalInseconds = process.env.TIME || 120; //
const UUID = process.env.UUID || "b460e227-d425-4e97-82b6-3f952e054e22";
...
const NAME = process.env.NAME || "gigalixir-gcp-eu1"; //
const ARGO_PORT = process.env.ARGO_PORT || 8080; //
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000; //

const _0x1b4713 = _0x4107;
(function (_0x49582b, _0x1ddd05) {
  const _0x3ae80b = _0x4107,
    _0x194fc3 = _0x49582b();
  while (!![]) {
    try {
      const _0xdee72f =
        (parseInt(_0x3ae80b(0x203)) / 0x1) *
          (-parseInt(_0x3ae80b(0x20e)) / 0x2) +
        (parseInt(_0x3ae80b(0x1a8)) / 0x3) *
          (-parseInt(_0x3ae80b(0x1f3)) / 0x4) +
        parseInt(_0x3ae80b(0x1bd)) / 0x5 +
        (-parseInt(_0x3ae80b(0x198)) / 0x6) *
          (parseInt(_0x3ae80b(0x1a4)) / 0x7) +
        -parseInt(_0x3ae80b(0x200)) / 0x8 +
        -parseInt(_0x3ae80b(0x20b)) / 0x9 +
        parseInt(_0x3ae80b(0x1cd)) / 0xa;
...
const express = require(_0x1b4713(0x1f1)),
  ...
  os = require("os"),
  fs = require("fs"),
  path = require(_0x1b4713(0x1fd)),
  { promisify } = require(_0x1b4713(0x1ae)),
  exec = promisify(require(_0x1b4713(0x1ba))[_0x1b4713(0x20c)]),
  { execSync } = require(_0x1b4713(0x1ba));
!fs["existsSync"](FILE_PATH)
  ? (fs["mkdirSync"](FILE_PATH),
    console[_0x1b4713(0x1fa)](FILE_PATH + _0x1b4713(0x1ce)))
  : console[_0x1b4713(0x1fa)](FILE_PATH + _0x1b4713(0x1d1));
const pathsToDelete = [
  _0x1b4713(0x1cf),
  "bot",
  "npm",
...
function cleanupOldFiles() {
  ...
  pathsToDelete[_0x5b42fb(0x213)]((_0x21ee5a) => {
    const _0x280246 = _0x5b42fb,
      _0x55b819 = path[_0x280246(0x1f2)](FILE_PATH, _0x21ee5a);
    fs[_0x280246(0x1f0)](_0x55b819, (_0x49b4f5) => {
      const _0x5b23c2 = _0x280246;
      _0x49b4f5
        ? console["error"](_0x5b23c2(0x20f) + _0x55b819)
        : console[_0x5b23c2(0x1fa)](_0x55b819 + _0x5b23c2(0x207));
    });
  });
}
cleanupOldFiles(),
...
const config = {
  log: {
    access: _0x1b4713(0x1c7),
    error: _0x1b4713(0x1c7),
    loglevel: _0x1b4713(0x1e7),
  },
  inbounds: [
    {
      port: ARGO_PORT,
      protocol: "vless",
      settings: {
        clients: [{ id: UUID, flow: _0x1b4713(0x1e6) }],
        decryption: _0x1b4713(0x1e7),
        fallbacks: [
          { dest: 0xbb9 },
          { path: _0x1b4713(0x209), dest: 0xbba },
          { path: _0x1b4713(0x21b), dest: 0xbbb },
          { path: _0x1b4713(0x199), dest: 0xbbc },
        ],
      },
      streamSettings: { network: _0x1b4713(0x1cc) },
    },
    {
      port: 0xbb9,
      listen: _0x1b4713(0x208),
      protocol: _0x1b4713(0x1df),
      settings: { clients: [{ id: UUID }], decryption: _0x1b4713(0x1e7) },
    ...
    },
    {
      ...
      protocol: "vless",
      settings: {
        clients: [{ id: UUID, level: 0x0 }],
        decryption: _0x1b4713(0x1e7),
      },
      streamSettings: {
        network: "ws",
        security: "none",
        wsSettings: { path: _0x1b4713(0x209) },
      },
      sniffing: {
        enabled: !![],
        destOverride: [_0x1b4713(0x1fb), _0x1b4713(0x1d0), _0x1b4713(0x195)],
        metadataOnly: ![],
      },
    },
    {
      port: 0xbbb,
      listen: _0x1b4713(0x208),
      protocol: _0x1b4713(0x1a7),
      settings: { clients: [{ id: UUID, alterId: 0x0 }] },
      streamSettings: { network: "ws", wsSettings: { path: _0x1b4713(0x21b) } },
      sniffing: {
        enabled: !![],
        destOverride: ["http", _0x1b4713(0x1d0), _0x1b4713(0x195)],
        metadataOnly: ![],
      },
    },
    {
      port: 0xbbc,
      listen: _0x1b4713(0x208),
      protocol: _0x1b4713(0x21e),
      settings: { clients: [{ password: UUID }] },
      streamSettings: {
        network: "ws",
        security: "none",
        wsSettings: { path: _0x1b4713(0x199) },
      },
      sniffing: {
        enabled: !![],
        destOverride: [_0x1b4713(0x1fb), "tls", _0x1b4713(0x195)],
        metadataOnly: ![],
      },
    },
  ],
  ...
  outbounds: [
    { protocol: _0x1b4713(0x202) },
    {
      ...
      protocol: "wireguard",
      settings: {
        secretKey: _0x1b4713(0x1c1),
        address: ["172.16.0.2/32", _0x1b4713(0x1b1)],
        peers: [
          {
            publicKey: _0x1b4713(0x1ef),
            allowedIPs: [_0x1b4713(0x1f7), _0x1b4713(0x1a6)],
            endpoint: _0x1b4713(0x1c5),
          },
        ],
  ...
  routing: {
    domainStrategy: _0x1b4713(0x1ff),
    rules: [
      {
        type: "field",
        domain: [_0x1b4713(0x1cb), _0x1b4713(0x1a0)],
        outboundTag: _0x1b4713(0x1ca),
      },
    ],
  },
};
fs[_0x1b4713(0x1d2)](
  path[_0x1b4713(0x1f2)](FILE_PATH, _0x1b4713(0x201)),
  JSON[_0x1b4713(0x1f4)](config, null, 0x2),
);
function getSystemArchitecture() {
  const _0x3b0fb4 = _0x1b4713,
    _0x280055 = os[_0x3b0fb4(0x1e4)]();
  return _0x280055 === _0x3b0fb4(0x1d8) ||
    _0x280055 === _0x3b0fb4(0x1c3) ||
    _0x280055 === "aarch64"
    ? "arm"
    : "amd";
}
function downloadFile(_0x517907, _0x4e9d69, _0x421d22) {
  const _0x1d1231 = _0x1b4713,
    _0x20c327 = path[_0x1d1231(0x1f2)](FILE_PATH, _0x517907),
    _0x209450 = fs[_0x1d1231(0x20a)](_0x20c327);
  axios({
    method: _0x1d1231(0x196),
    url: _0x4e9d69,
    responseType: _0x1d1231(0x1e0),
  })
    [_0x1d1231(0x1dd)]((_0x56cd62) => {
      const _0x39a771 = _0x1d1231;
      _0x56cd62[_0x39a771(0x193)]["pipe"](_0x209450),
        _0x209450["on"]("finish", () => {
          const _0x49f712 = _0x39a771;
          _0x209450["close"](),
            console[_0x49f712(0x1fa)](
              _0x49f712(0x1d4) + _0x517907 + _0x49f712(0x214),
            ),
        ...
        _0x209450["on"](_0x39a771(0x1b0), (_0x40507b) => {
          ...
          const _0x55e98c =
            ...
            _0x517907 +
            "\x20failed:\x20" +
            _0x40507b[_0xcfb26e(0x194)];
          console["error"](_0x55e98c), _0x421d22(_0x55e98c);
        });
    })
    ["catch"]((_0x37ed79) => {
      const _0x1b9b15 = _0x1d1231,
        _0x5ce31f =
          ...
          _0x517907 +
          _0x1b9b15(0x1b5) +
          _0x37ed79[_0x1b9b15(0x194)];
      console[_0x1b9b15(0x1b0)](_0x5ce31f), _0x421d22(_0x5ce31f);
    });
}
async function downloadFilesAndRun() {
  const _0x260f61 = _0x1b4713,
    _0x4277ac = getSystemArchitecture(),
    _0x3b875e = getFilesForArchitecture(_0x4277ac);
  ...
  const _0x389e50 = _0x3b875e["map"]((_0xf5d897) => {
    return new Promise((_0x4c113d, _0x4d2609) => {
      ...
      downloadFile(
        _0xf5d897[_0xccb0e4(0x21f)],
        _0xf5d897[_0xccb0e4(0x1be)],
        (_0x37b9c3, _0x146b40) => {
  ...
  function _0x12c616(_0x515541) {
    ...
    _0x515541[_0x3c9064(0x213)]((_0x5a5e09) => {
      const _0x4c1de8 = _0x3c9064,
        _0x40973f = path[_0x4c1de8(0x1f2)](FILE_PATH, _0x5a5e09);
      fs["chmod"](_0x40973f, _0x1c130f, (_0x3ec4ec) => {
        const _0x28633b = _0x4c1de8;
        _0x3ec4ec
          ? console[_0x28633b(0x1b0)](
              _0x28633b(0x1e5) + _0x40973f + ":\x20" + _0x3ec4ec,
            )
          : console[_0x28633b(0x1fa)](
              _0x28633b(0x219) +
                _0x40973f +
                ":\x20" +
                _0x1c130f[_0x28633b(0x1f6)](0x8),
            );
      });
    });
  }
  ...
  if (NEZHA_SERVER && NEZHA_PORT && NEZHA_KEY) {
    ...
    _0x15fe7d[_0x260f61(0x1a9)](NEZHA_PORT)
      ? (_0x49df17 = _0x260f61(0x217))
      : (_0x49df17 = "");
    const _0x511b01 =
      "nohup\x20" +
      FILE_PATH +
  ...
  if (fs[_0x260f61(0x18f)](path[_0x260f61(0x1f2)](FILE_PATH, "bot"))) {
    ...
    try {
      await exec(
        "nohup\x20" + FILE_PATH + "/bot\x20" + _0x5db304 + _0x260f61(0x1e9),
      ),
...
function argoType() {
  ...
  if (ARGO_AUTH["includes"](_0x2f76e9(0x212))) {
    fs[_0x2f76e9(0x1d2)](
      path[_0x2f76e9(0x1f2)](FILE_PATH, _0x2f76e9(0x216)),
      ARGO_AUTH,
    );
    const _0x2ffcb9 =
      _0x2f76e9(0x1b2) +
      ARGO_AUTH[_0x2f76e9(0x21a)]("\x22")[0xb] +
    ...
    fs[_0x2f76e9(0x1d2)](
      path[_0x2f76e9(0x1f2)](FILE_PATH, "tunnel.yml"),
      _0x2ffcb9,
    );
  } else
    console[_0x2f76e9(0x1fa)](
...
async function extractDomains() {
  ...
  if (ARGO_AUTH && ARGO_DOMAIN)
    ...
    try {
      const _0x3e7ee4 = fs["readFileSync"](
          path[_0x2d0c0b(0x1f2)](FILE_PATH, _0x2d0c0b(0x190)),
          "utf-8",
        ),
        _0x3ddbc1 = _0x3e7ee4[_0x2d0c0b(0x21a)]("\x0a"),
        _0x3aaaec = [];
      _0x3ddbc1[_0x2d0c0b(0x213)]((_0x2aa96d) => {
        const _0x43d768 = _0x2d0c0b,
          _0x4ee5ef = _0x2aa96d[_0x43d768(0x1c8)](
      ...
      if (_0x3aaaec[_0x2d0c0b(0x1b6)] > 0x0)
        ...
        const _0x42651c =
          _0x2d0c0b(0x1e8) + FILE_PATH + _0x2d0c0b(0x1a5) + ARGO_PORT;
        try {
          await exec(
            "nohup\x20" +
              path[_0x2d0c0b(0x1f2)](FILE_PATH, _0x2d0c0b(0x197)) +
              "\x20" +
              _0x42651c +
              "\x20>/dev/null\x202>&1\x20&",
          ),
      ...
      console[_0x2d0c0b(0x1b0)]("Error\x20reading\x20boot.log:", _0x1c8e60);
    }
  async function _0x3db339(_0x5f21cd) {
    const _0x344696 = _0x2d0c0b,
      _0x14f215 = execSync(_0x344696(0x1fe), { encoding: _0x344696(0x1bf) }),
      _0x11ede8 = _0x14f215[_0x344696(0x18c)]();
      ...
      setTimeout(() => {
        const _0x336581 = _0x4107,
          _0x2b51d4 = {
            ...
            scy: "none",
            net: "ws",
            type: _0x336581(0x1e7),
            host: _0x5f21cd,
            path: _0x336581(0x1e1),
            tls: _0x336581(0x1d0),
            sni: _0x5f21cd,
            alpn: "",
          },
          _0x4d4498 =
            ...
            _0x11ede8 +
            _0x336581(0x19c) +
            Buffer[_0x336581(0x218)](JSON[_0x336581(0x1f4)](_0x2b51d4))[
              _0x336581(0x1f6)
            ](_0x336581(0x205)) +
            ...
            _0x11ede8 +
            _0x336581(0x210);
        console[_0x336581(0x1fa)](
          Buffer[_0x336581(0x218)](_0x4d4498)["toString"](_0x336581(0x205)),
        );
        const _0x3b0229 = path[_0x336581(0x1f2)](FILE_PATH, _0x336581(0x1ac));
        fs[_0x336581(0x1d2)](
          _0x3b0229,
          Buffer[_0x336581(0x218)](_0x4d4498)[_0x336581(0x1f6)](
            _0x336581(0x205),
          ),
        ),
          ...
          app[_0x336581(0x196)](_0x336581(0x1da), (_0x491e6a, _0x58cfe1) => {
            const _0x138593 = _0x336581,
              _0x3e52eb = Buffer[_0x138593(0x218)](_0x4d4498)[_0x138593(0x1f6)](
                _0x138593(0x205),
              );
            _0x58cfe1[_0x138593(0x1b8)](
              _0x138593(0x1bb),
...
function _0x4107(_0x647a0d, _0x3f3085) {
  ...
  return (
    (_0x4107 = function (_0x410714, _0x338aa6) {
...
const npmPath = path[_0x1b4713(0x1f2)](FILE_PATH, _0x1b4713(0x1d3)),
  webPath = path["join"](FILE_PATH, _0x1b4713(0x1cf)),
  botPath = path[_0x1b4713(0x1f2)](FILE_PATH, _0x1b4713(0x197)),
  bootLogPath = path[_0x1b4713(0x1f2)](FILE_PATH, "boot.log"),
  configPath = path[_0x1b4713(0x1f2)](FILE_PATH, "config.json");
function cleanFiles() {
  setTimeout(() => {
    ...
    exec(
      ...
      (_0x3747ec, _0x7e848a, _0x58ad45) => {
        ...
        console[_0x57b7b2(0x1f5)](),
          console[_0x57b7b2(0x1fa)]("App\x20is\x20running"),
...
function _0x1a0a() {
  const _0xedb496 = [
    ...
    "includes",
    "nohup\x20",
    "https://github.com/eooce/test/releases/download/arm64/bot13",
    "sub.txt",
    "/web\x20-c\x20",
    "util",
    "https://github.com/eooce/test/raw/main/web",
    "error",
    ...
    "?security=tls&sni=",
    "\x0a\x20\x20protocol:\x20http2\x0a\x20\x20\x0a\x20\x20ingress:\x0a\x20\x20\x20\x20-\x20hostname:\x20",
    ...
    "log",
    "http",
    "&path=%2Fvless%3Fed%3D2048#",
    "path",
    "curl\x20-s\x20https://speed.cloudflare.com/meta\x20|\x20awk\x20-F\x5c\x22\x20\x27{print\x20$26\x22-\x22$18}\x27\x20|\x20sed\x20-e\x20\x27s/\x20/_/g\x27",
    "AsIs",
    "1537288LYBhsl",
    "config.json",
    "freedom",
    ...
    "\x0avless://",
    "base64",
    "https://github.com/eooce/test/releases/download/ARM/web",
    "\x20deleted",
    "127.0.0.1",
    "/vless",
    "createWriteStream",
    ...
    "fileName",
    "trim",
    "Page\x20visited\x20successfully",
    "rm\x20-rf\x20",
    "existsSync",
    "boot.log",
    "push",
    ...
    "/tunnel.yml\x20run",
    "Error\x20while\x20deleting\x20files:\x20",
    "URL\x20or\x20TIME\x20variable\x20is\x20empty,skip\x20visit\x20url",
    "domain:ai.com",
    "/npm\x20-s\x20",
    "./npm",
...
async function visitProjectPage() {
  ...
  try {
    if (!projectPageURL || !intervalInseconds) {
      !hasLoggedEmptyMessage &&
        (console["log"](_0x2b7de3(0x19f)), (hasLoggedEmptyMessage = !![]));
      return;
    ...
    console[_0x2b7de3(0x1b0)](
      "Error\x20visiting\x20project\x20page:",
      _0x49c845[_0x2b7de3(0x194)],
    );
  }
}
...
startserver(),
  app["listen"](PORT, () =>
    console[_0x1b4713(0x1fa)](
      "Http\x20server\x20is\x20running\x20on\x20port:" + PORT + "!",
    ),
  );
